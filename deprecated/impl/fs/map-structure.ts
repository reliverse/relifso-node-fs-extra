import type { ReadFileOptions, MapStructureResult, MapStructureFunction } from "deprecated/types.js";

import { _diveWorker, dive } from "./dive.js";
import * as fs from "./index.js";

async function _mapStructureProcessFile(
  file: string,
  stat: fs.Stats,
  mapper: MapStructureFunction<string> | MapStructureFunction<Buffer>,
  readOptions: ReadFileOptions | BufferEncoding | undefined,
  writeOptions: fs.WriteFileOptions | BufferEncoding | undefined,
) {
