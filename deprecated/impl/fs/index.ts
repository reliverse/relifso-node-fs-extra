 ...
 */
export const write: typeof fs.write & typeof fs.write.__promisify__ = universalify(
  gfs.write,
 ...
 */
export const read: typeof fs.read & typeof fs.read.__promisify__ = universalify(gfs.read, (bytesRead, buffer) => ({
  bytesRead,
  buffer,
}));
/**
 ...
 */
export const writev: typeof fs.writev & typeof fs.writev.__promisify__ = universalify(
  gfs.writev,
 ...
 */
export const readv: typeof fs.readv & typeof fs.readv.__promisify__ = universalify(gfs.readv, (bytesRead, buffers) => ({
  bytesRead,
  buffers,
}));
/**
