import type { ErrorCallback } from "deprecated/types.js";

import * as fs from "./index.js";

async function _forEachChildHelper(
  path: string,
  options:
    | (({ encoding: BufferEncoding | null } | BufferEncoding | null | undefined) & ({ encoding: "buffer" } | "buffer"))
    | undefined,
  func: (filename: string | Buffer) => void | Promise<void>,
) {
...
export function forEachChild(
  path: string,
  options: { encoding: BufferEncoding | null } | BufferEncoding | null | undefined | Record<string, never>,
  func: (filename: string) => void | Promise<void>,
): Promise<void>;
export function forEachChild(
  path: string,
  options: { encoding: "buffer" } | "buffer",
  func: (filename: Buffer) => void | Promise<void>,
): Promise<void>;
export function forEachChild(path: string, func: (filename: string) => void | Promise<void>): Promise<void>;
export function forEachChild(
  path: string,
  options: { encoding: BufferEncoding | null } | BufferEncoding | null | undefined | Record<string, never>,
  func: (filename: string) => void,
  callback: ErrorCallback,
): void;
export function forEachChild(
  path: string,
  options: { encoding: "buffer" } | "buffer",
  func: (filename: Buffer) => void,
  callback: ErrorCallback,
): void;
...
export function forEachChild(
  ...
  o2?: ((filename: string) => void | Promise<void>) | ((filename: Buffer) => void | Promise<void>) | ErrorCallback,
  o3?: ErrorCallback,
): void | Promise<void> {
  const options =
    // biome-ignore lint/suspicious/noDoubleEquals: <explanation>
    typeof o1 == "object"
      ? (o1 as ({ encoding: BufferEncoding | null } | BufferEncoding | null | undefined) &
          ({ encoding: "buffer" } | "buffer"))
      : undefined;
...
export function forEachChildSync(
  ...
  options?:
    | ({ encoding: "buffer" } | "buffer")
    | ({ encoding: BufferEncoding | null } | BufferEncoding | null | Record<string, never>),
) {
  const children: string[] | Buffer[] = fs.readdirSync(
    path,
    options as
      | (({ encoding: "buffer" } | "buffer") &
          ({ encoding: BufferEncoding | null } | BufferEncoding | null | undefined))
      | undefined,
  );
  for (const child of children) {
    (func as (filename: string | Buffer) => void)(child);
