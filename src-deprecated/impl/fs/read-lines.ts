...
export function readLines(
  path: string,
  encoding: BufferEncoding,
  callback: (err: NodeJS.ErrnoException | null, lines?: string[]) => void,
): void;
...
export function readLines(
  path: string,
  o1?: BufferEncoding | ((err: NodeJS.ErrnoException | null, lines?: string[]) => void),
  o2?: (err: NodeJS.ErrnoException | null, lines?: string[]) => void,
): void | Promise<string[]> {
