...
import { rename as _rename } from '~/impl/fs/index.js';
import { copy } from '~/impl/lib/copy/index.js';
import { mkdirs } from '~/impl/lib/mkdirs/index.js';
import { remove } from '~/impl/lib/remove/index.js';
import * as stat from '~/impl/lib/util/stat.js';
...
async function _move(src: string, dest: string, opts: MoveOptions = {}): Promise<
  void
> {
