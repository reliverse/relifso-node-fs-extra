 ...
 */
export type MapChildrenFunction<T> = (
  contents: T,
  filename: string,
  pathOnly: string,
 ...
 * @returns the value to pass to [[writeFile]], or a [[Promise]] resolving to the value to pass to [[writeFile]].
 */
export type MapStructureFunction<T> = (
  contents: T,
  fullPath: string,
  stat: fs.Stats,
 ...
 */
export type DiveActionCallback = (
  err: Error | null,
  file?: string,
  stat?: fs.Stats,
) => void;
 ...
 */
export type MapStructureResult = {
  /**
