import { isWhitespace } from "~/utils/json/helpers/stringUtils.js";
...
export function createOutputBuffer({ write, chunkSize, bufferSize }: OutputBufferOptions): OutputBuffer {
  let buffer = "";
  let offset = 0;
